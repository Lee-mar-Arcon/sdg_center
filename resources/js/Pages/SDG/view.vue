    ...
    <div class="max-w-screen min-h-screen p-10 pt-[180px]">
        <div class="grid grid-cols-12 grid-flow-row">
            <div class="col-span-2 p-1 flex flex-col">
                <h1>SDG HOME</h1>
                <img src="../../../../public/sdg/02.png" class="p-2 mb-5 aspect-square max-w-full" alt="">
...
<!--                    <div class="line-clamp-1 text-start italic">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium labore minus cumque! Nobis, deleniti est sit placeat voluptates ab fugiat asperiores voluptatibus aspernatur voluptatem vero! Illo maxime ex a quos!</div>-->
<!--                </article>-->
            </div>
            ...
            <div class="col-span-8 p-10">
                <div class="flex justify-end w-full pb-2">
                    <img v-for="sdg in [1,4,2,5,3,9]" :key="sdg" :src="'/sdg/0'+ sdg + '.png'" class="object-cover mx-1 max-h-[40px] aspect-square max-w-full" alt="">
                </div>
                <img src="../../../../public/sdg/02.png" class="object-cover aspect-video max-w-full" alt="">
                <h1 class="text-4xl pt-5 text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi consectetur, repellendus nisi at vitae odio beatae sunt ullam exercitationem pariatur? </h1>
                <p class="italic pt-2">Jane Doe - July 26, 1999</p>
                <article class="text-justify indent-10 pt-10">
            ...
            <div class="col-span-2 p-1 flex flex-col">
                <h1 class="mb-5">OTHER STORIES</h1>

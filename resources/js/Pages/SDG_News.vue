    ...
    <div class="layout-wrapper">
        ...
        <div class="flex flex-col md:flex-row min-h-screen px-4 md:px-0">
            ...
            >
                <Link href="/">
                    <p
                        class="text-lg cursor-pointer underline underline-offset-1"
                    >
                        Sdg Home
                    </p>
                </Link>
                <div
                    class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-1 items-center p-2"
                >
                ...
                <div v-if="selectedSdg">
                    <el-row class="tac pt-12 md:pt-16">
                        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                            <h5 class="mb-2 text-lg md:text-xl">
                            ...
                            <template v-for="metric in selectedSdg.metrics">
                                ...
                                >
                                    <el-menu-item
                                        v-for="question in metric.indicators"
                                        :key="question.id"
            ...
            <div class="flex-grow p-4 md:p-8 rounded-lg main-content">
                <div class="flex flex-col md:flex-row items-center mb-4">
                    ...
                    <p
                        v-if="selectedSdg !== null"
                        class="text-lg text-left w-full md:max-w-md"
                    >
                ...
                <div class="flex flex-wrap gap-4 mb-4">
                    <div
                        class="flex flex-wrap overflow-x-auto space-x-5 py-3 w-full justify-center"
                    >
                        <div
